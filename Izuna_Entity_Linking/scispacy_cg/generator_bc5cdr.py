...
class CandidateGenerator:
    ...
    def __init__(
        ...
        self.ann_index = ann_index or load_approximate_nearest_neighbours_index(linker_paths=linker_paths, ef_search=ef_search)
        self.vectorizer = tfidf_vectorizer or joblib.load(cached_path(linker_paths.tfidf_vectorizer))
        self.ann_concept_aliases_list = json.load(open(cached_path(linker_paths.concept_aliases_list)))
		#json.load(open(cached_path(linker_paths.concept_aliases_list)), "concept_aliases.json", encoding = "utf-8"
