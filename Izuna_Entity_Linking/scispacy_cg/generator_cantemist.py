...
class CandidateGenerator:
    ...
    def __init__(
        ...
        self.ann_index = nmslib.init(
            method="hnsw",
            space="cosinesimil_sparse",
            data_type=nmslib.DataType.SPARSE_VECTOR,
        )
        query_time_params = {"efSearch": ef_search}
        selfann_index.setQueryTimeParams(query_time_params)
        self.vectorizer = tfidf_vectorizer
        self.ann_concept_aliases_list = json.load(open("concept_aliases.json", encoding = "utf-8"))
