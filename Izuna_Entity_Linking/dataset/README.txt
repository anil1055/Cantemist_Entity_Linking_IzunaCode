Cantemist shared task train, dev set 1, dev set 2 and test+background set.

It contains the train and development sets of the three subtasks: cantemist-ner, cantemist-norm and cantemist-coding with Gold Standard annotations.
